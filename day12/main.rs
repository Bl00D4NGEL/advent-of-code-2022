...
fn main() {
    // Part 1 was too hard for me because I didn't consider looking up distance based algorithms.
    // Apparently the algo to use was Dijkstra's algorithm (see https://en.wikipedia.org/wiki/Dijkstra%27s_algorithm#Algorithm)
    println!("Day 12 part 1: {}", part_one().unwrap());
    // And given that I copy-pasted like an idiot I didn't understand how to solve part 2 so I copy-pasted that, too :)
    // Full credit goes to https://github.com/morlinbrot/aoc22/blob/main/src/d12.rs
    println!("Day 12 part 2: {}", part_two().unwrap());
}
